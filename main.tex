...
\begin{tikzpicture}
    ...
    \draw[line width=0.5mm, smooth, samples=100, domain=0.5*\PI:0.9*\PI] plot ((\x-0.1*\PI,{0.3*sin(\x*10 r)-4.8});
    \draw[line width=0.5mm, smooth, samples=100, domain=0.8*\PI:1.6*\PI] plot (\x,{0.3*sin(\x*10 r)-4.8});
    \draw[line width=0.5mm, smooth, samples=100, domain=1.7*\PI:2.1*\PI] plot  ((\x-0.1*\PI,{0.3*sin(\x*10 r)-4.8});

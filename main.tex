...
\begin{itemize}
    ...
    \end{description}
    \item 4B/5B kodiert je 4~bit (Nibble) in 5~bit (siehe Tabelle)
\end{itemize}
\end{minipage}
...
\renewcommand{\arraystretch}{1.5}
    \begin{tabular}{l|c|l|l|l}
        ...
        \hline
        Ethernet & $10\frac{\text{Mbit}}{\text{s}}$ & 64 Oktette & 8 Oktette & 12 Oktette \\
        ...
        10-Gigabit Ethernet & $10\frac{\text{Gbit}}{\text{s}}$ & 512 Oktette, kein CSMA/CD & 8 Oktette & $\geq 5$ Oktette
    \end{tabular}
}
%
\begin{itemize}
    \item Die \textit{Mindestframegröße} \footnote{Für genauere Informationen siehe \href{http://www.trincoll.edu/Academics/MajorsAndMinors/Engineering/Documents/IEEE\%20Standard\%20for\%20Ethernet.pdf}{IEEE 802.3}} wird für \textit{CSMA/CD} benötigt
    \item SDL: Start Delimiter
    \item IFG: Interframe Gap
\end{itemize}
%
\begin{description}[style=unboxed,leftmargin=0cm]
...
\begin{description}
    \item[CSMA/CD (\textit{Carrier-sense multiple access / collision detection})] Beim Senden lauscht man nach Signalen anderer Kommunikationsteilnehmer (Bus-Topologie). Hört man andere, sendet man Jam-Signal auf die Leitung, sodass das CRC des gesendeten Frames beim Empfänger fehlschlägt, und wartet eine zufällige Dauer bevor man das Senden erneut versucht.
    %
